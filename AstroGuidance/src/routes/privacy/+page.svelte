	...
	<article class="prose lg:prose-xl text-center my-10">
		...
		<ul>
			...
			<li>
				<p>
					...
					<span class="text-accent">&quot;the Company&quot;</span>,
					<span class="text-accent">&quot;We&quot;</span>,
					<span class="text-accent">&quot;Us&quot;</span> or <span class="text-accent">&quot;Our&quot;</span>
					in this Agreement) refers to
					<span class="text-primary">AstroGuidance</span>, Huttiheita 69, Haugesund, Rogaland.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p><strong>Country</strong> refers to: <span class="text-accent">Norway</span></p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to <span class="text-primary">AstroGuidance</span>, accessible from
					<a href="astroguidance.com" rel="external nofollow noopener" target="_blank">astroguidance.com</a>
				</p>
			</li>
			<li>
				<p>
		...
		<ul>
			...
			<li>
				...
				electronic files known as web beacons (also referred to as <span class="text-accent">clear gifs</span>,
				<span class="text-accent">pixel tags</span>, and <span class="text-accent">single-pixel gifs</span>)
		...
		<p>
			Cookies can be <span class="text-accent">&quot;Persistent&quot;</span> or
			<span class="text-accent">&quot;Session&quot; cookies</span>. Persistent Cookies remain on Your personal
		...
		<ul>
			...
			<li>
				<p>
					...
					of electronic communication, such as a mobile application's push notifications regarding updates or informative
		...
		<p>
			...
			remove that information from Our servers. It is important to note that this website & service is targeted to
			consenting adults, where adult is defined by required legal age of the user for this service.
		</p>
		<p>
		...
		<ul>
			<li class="text-accent">By email: astroguidance@gmail.com</li>
		</ul>
	</article>
</main>

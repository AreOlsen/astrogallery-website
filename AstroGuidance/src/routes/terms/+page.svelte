<main class="flex flex-col justify-center items-center w-full">
	<article class="prose lg:prose-xl text-center my-10">
		...
		<p>
			These terms and conditions outline the rules and regulations for the use of <span class="text-primary"
				>Astroguidance</span
			>'s Website, located at <span class="text-primary">Astroguidance.com</span>.
		</p>

		<p>
			By accessing this website we assume you accept these terms and conditions. Do not continue to use
			<span class="text-primary">Astroguidance</span> if you do not agree to take all of the terms and conditions stated
			on this page.
		</p>

		<p>
			The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
			all Agreements: "<span class="text-accent">Client</span>", "<span class="text-accent">You</span>" and "<span
				class="text-accent">Your</span
			>" refers to you, the person log on this website and compliant to the Company's terms and conditions. "<span
				class="text-accent">The Company</span
			>", "<span class="text-accent">Ourselves</span>", "<span class="text-accent">We</span>", "<span
				class="text-accent">Our</span
			>" and "<span class="text-accent">Us</span>", refers to our Company. "<span class="text-accent">Party</span
			>", "<span class="text-accent">Parties</span>", or "<span class="text-accent">Us</span>", refers to both the
			Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to
			undertake the process of our assistance to the Client in the most appropriate manner for the express purpose
			of meeting the Client's needs in respect of provision of the Company's stated services, in accordance with
			and subject to, prevailing law of no. Any use of the above terminology or other words in the singular,
		...
		<p>
			We employ the use of cookies. By accessing <span class="text-primary">Astroguidance</span>, you agreed to
			use cookies in agreement with the
			<span class="text-primary">Astroguidance</span>'s Privacy Policy.
		</p>
		...
		<p>
			Unless otherwise stated, <span class="text-primary">Astroguidance</span> and/or its licensors own the
			intellectual property rights for all material on <span class="text-primary">Astroguidance</span>. All
			intellectual property rights are reserved. You may access this from
			<span class="text-primary">Astroguidance</span> for your own personal use subjected to restrictions set in these
			terms and conditions.
		</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from <span class="text-primary">Astroguidance</span></li>
			<li>Sell, rent or sub-license material from <span class="text-primary">Astroguidance</span></li>
			<li>Reproduce, duplicate or copy material from <span class="text-primary">Astroguidance</span></li>
			<li>Redistribute content from <span class="text-primary">Astroguidance</span></li>
		</ul>
		...
		<p>
			...
			certain areas of the website. <span class="text-primary">Astroguidance</span> does not filter, edit, publish
			or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of
			<span class="text-primary">Astroguidance</span>,its agents and/or affiliates. Comments reflect the views and
			opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
			<span class="text-primary">Astroguidance</span> shall not be liable for the Comments or for any liability, damages
			or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
			on this website.
		</p>

		<p>
			<span class="text-primary">Astroguidance</span> reserves the right to monitor all Comments and to remove any
		...
		<p>
			You hereby grant <span class="text-primary">Astroguidance</span> a non-exclusive license to use, reproduce, edit
		...
		<p>
			...
			of <span class="text-primary">Astroguidance</span>; and (d) the link is in the context of general resource
			information.
		</p>
		...
		<p>
			...
			website, you must inform us by sending an e-mail to <span class="text-primary">Astroguidance</span>. Please
		...
		<p>
			No use of <span class="text-primary">Astroguidance</span>'s logo or other artwork will be allowed for
